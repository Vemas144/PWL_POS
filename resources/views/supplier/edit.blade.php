...
<div class="card card-outline card-primary"> 
    ...
    <div class="card-body"> 
      ...
      @else 
        <form method="POST" action="{{ url('/supplier/'.$supplier->supplier_id) }}" class="form
horizontal"> 
          @csrf 
...
old('supplier_alamat', $supplier->supplier_alamat) }}" required> 
          ...
          <div class="form-group row"> 
            ...
            <div class="col-11"> 
              <input type="text" class="form-control" id="supplier_telepon" name="supplier_telepon" value="{{ 
old('supplier_telepon', $supplier->supplier_telepon) }}" required> 
...
old('supplier_email', $supplier->supplier_email) }}" required> 
