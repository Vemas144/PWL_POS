...
$supplier->supplier_nama }}</td></tr>
                    <tr><th class="text-right col-3">Alamat :</th><td class="col-9">{{ 
$supplier->supplier_alamat }}</td></tr>
                    <tr><th class="text-right col-3">Telepon :</th><td class="col-9">{{ 
$supplier->supplier_telepon }}</td></tr>
                    <tr><th class="text-right col-3">Email :</th><td class="col-9">{{ 
$supplier->supplier_email }}</td></tr>
                </table>
            </div>
